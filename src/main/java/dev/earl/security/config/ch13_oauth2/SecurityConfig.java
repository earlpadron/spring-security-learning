...
//    }
//
//    //UserDetailsService and Password encoder are just dummy implementations, SHOULD write custom implementations
//    @Bean
...
//                )
////                .clientSettings(ClientSettings.builder()       //this disables PKCE
...
////                .scope("CUSTOM")   //might be better to call it "LIVELINESS"
////                .build();
//
//        /**
...
//         *
//         * This non-opaque token can then be used for introspection to retrieve further details about the client entity and user(if applicable)
//         */
...
////                .clientAuthenticationMethod(ClientAuthenticationMethod.CLIENT_SECRET_BASIC)
////                .authorizationGrantType(AuthorizationGrantType.CLIENT_CREDENTIALS)
////               //notice: tokenSettings was added to change the access token format and make it Opaque
//
